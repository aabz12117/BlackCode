...
import { Scan, AlertTriangle, ChevronLeft, Ban, Lock } from "lucide-react";
...
export const LoginScreen = ({ onLogin, users }: LoginScreenProps) => {
    ...
    const handleLogin = (uName: string, pCode: string, isAutoQr: boolean = false) => {
        ...
        if (user) {
            ...
            // تقليل وقت الانتظار من 1500ms إلى 300ms
            setTimeout(() => {
                onLogin(user);
            }, 300);
        ...
        <div className="min-h-screen bg-black text-white font-sans relative overflow-hidden flex items-center justify-center p-6" dir="rtl">
            ...
            {isLoading && (
                <div className="fixed inset-0 z-50 bg-black/90 flex flex-col items-center justify-center">
                    ...
                    <h2 className="text-xl font-black text-white mb-2 tracking-widest">جاري المصادقة</h2>
                    <p className="text-primary font-mono text-sm">يتم التحقق من بيانات الاعتماد...</p>
                </div>
            )}

            {/* Main Card */}
            <div className="relative z-10 w-full max-w-md bg-black/90 border border-primary/20 p-8 shadow-[0_0_30px_rgba(59,130,246,0.1)] rounded-2xl">
                    ...
                    <form onSubmit={handleManualSubmit} className="space-y-6">
                        <div className="space-y-5">
                            <div className="group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#050505] border border-white/10 text-white px-4 py-4 rounded-lg outline-none focus:border-primary transition-colors placeholder-dim/30 font-sans text-right text-sm"
                            ...
                            <div className="group">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-[#050505] border border-white/10 text-white px-4 py-4 rounded-lg outline-none focus:border-alert transition-colors placeholder-dim/30 font-mono text-center text-xl"
                                        placeholder="0000"
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            <button
                                type="submit"
                                style={{ touchAction: 'manipulation' }}
                                className="w-full bg-primary active:bg-blue-700 text-black font-black py-4 rounded-lg transition-colors"
                            >
                                <span className="flex items-center justify-center gap-2 tracking-wider font-sans text-lg">
                            ...
                            <button
                                ...
                                style={{ touchAction: 'manipulation' }}
                                className="w-full bg-white/5 border border-white/10 active:border-primary/50 text-white rounded-lg py-3 transition-colors"
                            >
